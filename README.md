...
<body>
    <div class="banner">
        <br>
        <div class="navbar">
            <h1 class="logo">PNK STARTUP'S</h1>
            <ul>
        ...
        <div class="content">
            <div class="text">
                <h2>A NEW STARTUP COMPANY</h2>
                <br>
                <p>"If we tried to think of a good idea, we wouldn't have been able to think of a good idea. ...</p>
                <br>
                <div>
                    <img src="startup.png" width="1000px" height="500px">
                </div>
    ...
    <footer>
        <center>Designed and Developed S.L.NARASIMHA REDDY(212223040214) &copy; 2024</center>
    </footer>
</body>
</html>
...
<body>
    <div class="banner">
        ...
        <div class="container">
            <div class="box-container">
                ...
                <div class="box">
                    <h3>AMAZON</h3>
                    <image src="AMAZON.jpg" width="200" height="500"></image>
                </div>
                <div class="box">
                    <h3>GOOGLE</h3>
                    <image src="GOOGLE.jpg" width="160" height="500"></image>
                </div>
                <div class="box">
                    <h3 >WIPRO</h3>
                ...
                <div class="box">
                    <h3 >CISCO</h3>
                    <image src="CISCO.jpg" width="160" height="500"></image>
                </div>
                <div class="box">
                    <h3 >FLIPKART</h3>
                    <image src="FLIPKART.jpg" width="200" height="500"></image>
                </div>
    ...
    <footer>
        <center>Designed and Developed by S.L.NNARASIMHA REDDY(212223040214) &copy; 2024</center>
    </footer>
</body>
</html>
...
<body>
    <div class="banner">
        ...
        <div class="image">
            <table cellspacing="20"> 
                <tr align="center">
                    <td> <img src="PRABHAS.jpeg"> </td>
                    <td> <img src="NTR.jpeg"> </td>
                    <td> <img src="ALLU ARJUN.jpeg"> </td>
                    <td> <img src="RAM CHARAN.jpeg"> </td>
    ...
    <footer>
        <center>Designed and Developed by S.L.NARASIMHA REDDY(212223040214) &copy; 2024</center>
    </footer>
</body>
</html>
    ...
    <div class="banner">
        ...
        <div class="box">
            ...
            <div class="box-2"> 
                ...
                <p> <span>Address</span> : 12/3,MAIN STREET,ANNA NAGAR,CHENNAI 602 405</p>
                <p> <span>Email</span> : NARAPAVI@gmail.com </p>
                <p> <span>Phone</span> : 6600-002-002</p>
            </div>
        </div>
    </div>
    <footer>
